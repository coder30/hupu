        ...
        renderItem={({item, index}) =>
            <View>
                <View style={{flexDirection: 'row', backgroundColor: 'rgba(0, 0, 0, 0.12)', padding: 7}}>
                    ...
                    <Text style={{paddingRight: 35, fontSize: 12}}>球队</Text>
                    <Text style={{paddingRight: 17, fontSize: 12}}>数据</Text>
                </View>
                <FlatList
                data={item.data}
                showsVerticalScrollIndicator = {false}
                ...
                renderItem={({item,index}) =>
                  <View style={{flexDirection: 'row', padding:5, backgroundColor: color[index%2]}}>
                    ...
                    <Text style={{lineHeight:30, paddingRight: 10, minWidth: 60}}>{item.team_name}</Text>
                    <Text style={{lineHeight:30, paddingRight: 5}}>{item.val}</Text>
                  </View>
                }
                />
            </View>
